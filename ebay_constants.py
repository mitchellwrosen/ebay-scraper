# eBay RSS keys
kRSSKeyBidCount = 'rx_bidcount'
kRSSKeyEndTime = 'rx_endtime'
kRSSKeyBuyItNowPrice = 'rx_buyitnowprice'
kRSSKeyCurrentPrice = 'rx_currentprice'
...
# eBay GET values
kGETValueSortByTimeNewlyListed = '10'
